...
function! Core#Plugin#Manager (dir_path) abort
	...
	let l:site_rtp_dir_path = '~/.cache/cvim/site'
	...
	try
		...
		echomsg '$ curl -fLo ~/.cache/cvim/site/autoload/plug.vim --create-dirs https://raw.githubusercontent.com/junegunn/vim-plug/master/plug.vim'
		return
	endtry
